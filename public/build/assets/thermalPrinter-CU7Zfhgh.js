...
`,`${s}VA\0`].join("");await this.write(e)}async printTicket(e){console.log("[ThermalPrinter] printTicket() called with data:",e);const r=e.side.toUpperCase(),t=e.event_name||"SABONG EVENT";console.log("[ThermalPrinter] Building ESC/POS commands with QR code..."),console.log("[ThermalPrinter] Event name to print:",t);const n=[`${i}@`,`${i}a`,`${i}!0`,`${t}
`,`${i}!\0`,`================================
`,`
`,`${i}a\0`,`Fight#:  ${e.fight_number}
`,`Teller:  Teller
`,`Receipt: ${e.ticket_id.substring(0,13)}
`,`Date:    ${new Date().toLocaleDateString("en-US",{month:"2-digit",day:"2-digit",year:"numeric"})}
`,`Time:    ${new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0})}
`,`
`,`================================
`,`
`,`${i}a`,`${i}!0`,`${r} - P${e.amount.toLocaleString()}
`,`${i}!\0`,`Win: P${e.potential_payout.toLocaleString()}
`,`
`,`================================
`,`
...
`,`${s}VA\0`].join("");console.log("[ThermalPrinter] Commands built, length:",n.length),console.log("[ThermalPrinter] Calling write()...");try{await this.write(n),console.log("[ThermalPrinter] ✅ write() completed successfully")}catch(c){throw console.error("[ThermalPrinter] ❌ write() failed:",c),c}}}const m=new l;export{m as t};
