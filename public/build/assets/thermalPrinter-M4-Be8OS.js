...
`,`================================
`,`
`,`${a}VA\0`].join("");await this.write(e)}async printTicket(e){console.log("[ThermalPrinter] printTicket() called with data:",e);const t=e.side.toUpperCase(),i=e.event_name||"SABONG EVENT";console.log("[ThermalPrinter] Building ESC/POS commands with QR code..."),console.log("[ThermalPrinter] Event name to print:",i);const n=[`${r}@`,`${r}a`,`${i}
`,`--------------------------------
`,`${r}a\0`,`${a}(k\x001A2\0`,`${a}(k\x001C`,`${a}(k\x001E0`,`${a}(k${String.fromCharCode(e.ticket_id.length+3)}\x001P0${e.ticket_id}`,`${a}(k\x001Q0`,`
`,`${r}a\0`,`#${e.fight_number} | ${e.ticket_id}
