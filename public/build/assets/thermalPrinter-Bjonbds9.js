...
`,`${a}VA\0`].join("");await this.write(e)}async printTicket(e){console.log("[ThermalPrinter] printTicket() called with data:",e);const r=e.side.toUpperCase(),t=e.event_name||"SABONG EVENT";console.log("[ThermalPrinter] Building ESC/POS commands with QR code..."),console.log("[ThermalPrinter] Event name to print:",t);const n=[`${i}@`,`${i}a`,`${i}!`,`${t}
`,`${i}!\0`,`================================
