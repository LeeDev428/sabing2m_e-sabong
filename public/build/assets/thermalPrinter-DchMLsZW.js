...
`,`${a}VA\0`].join("");await this.write(e)}async printTicket(e){console.log("[ThermalPrinter] printTicket() called with data:",e);const t=e.side.toUpperCase(),n=e.event_name||"SABONG EVENT";console.log("[ThermalPrinter] Building ESC/POS commands with QR code..."),console.log("[ThermalPrinter] Event name to print:",n);const i=[`${r}@`,`${r}a`,`${r}!`,`${n}
`,`${r}!\0`,`================================
...
`,`${a}VA\0`].join("");console.log("[ThermalPrinter] Commands built, length:",i.length),console.log("[ThermalPrinter] Calling write()...");try{await this.write(i),console.log("[ThermalPrinter] ✅ write() completed successfully")}catch(o){throw console.error("[ThermalPrinter] ❌ write() failed:",o),o}}async printPayoutReceipt(e){console.log("[ThermalPrinter] printPayoutReceipt() called with data:",e);const t=e.side.toUpperCase(),n=e.event_name||"SABONG EVENT";console.log("[ThermalPrinter] Building payout receipt ESC/POS commands...");const i=[`${r}@`,`${r}a`,`${r}!`,`${n}
`,`${r}!\0`,`================================
...
`,`${a}VA\0`].join("");console.log("[ThermalPrinter] Commands built, length:",i.length),console.log("[ThermalPrinter] Calling write()...");try{await this.write(i),console.log("[ThermalPrinter] ✅ Payout receipt printed successfully")}catch(o){throw console.error("[ThermalPrinter] ❌ Payout receipt print failed:",o),o}}async printRefundReceipt(e){console.log("[ThermalPrinter] printRefundReceipt() called with data:",e);const t=e.side.toUpperCase(),n=e.event_name||"SABONG EVENT",i=e.refund_reason||"DRAW";console.log("[ThermalPrinter] Building refund receipt ESC/POS commands...");const o=[`${r}@`,`${r}a`,`${r}!`,`${n}
`,`${r}!\0`,`================================
