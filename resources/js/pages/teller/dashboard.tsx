...
export default function TellerDashboard({ fights = [], summary, tellerBalance = 0, auth }: TellerDashboardProps) {
        ...
        router.post('/teller/bets', {
            ...
            onSuccess: (page) => {
                ...
                if (ticket) {
                    ...
                    // Add to recent bets for summary panel
                    setRecentBets(prev => [{
                        id: ticket.ticket_id,
                        side: betSide as 'meron' | 'wala' | 'draw',
                        amount: betAmount,
                        fight_number: selectedFight.fight_number,
                        timestamp: new Date(),
    ...
    // Get current odds for selected side
    const getCurrentOdds = () => {
        if (!betSide || !currentFightData) return null;
        if (betSide === 'meron') return currentFightData.meron_odds;
        if (betSide === 'wala') return currentFightData.wala_odds;
        return currentFightData.draw_odds;
    };
        ...
        <TellerLayout currentPage="dashboard">
            ...
            <div className="min-h-screen bg-[#1a1a1a]">
                ...
                <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="flex-1 lg:max-w-md mx-auto w-full p-3">
                        
                        {/* Fight Number Badge - Hexagonal Style */}
                        ...
                        {/* MERON & WALA Buttons - Side by Side */}
                        {selectedFight && (
                            <div 
                        ...
                        {/* Printer & Balance Status (Mobile only) */}
                        <div className="lg:hidden mt-4 flex justify-between items-center px-2">
                            ...
                            <div className="text-right">
                                ...
                                <span className="text-sm font-bold text-green-400">₱{liveBalance.toLocaleString()}</span>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="space-y-3 mb-4">
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className={`px-3 py-1 rounded text-sm font-bold ${
                                            betSide === 'meron' ? 'bg-red-600 text-white' :
                                            betSide === 'wala' ? 'bg-blue-600 text-white' :
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="text-white font-bold">₱ {parseInt(amount || '0').toLocaleString()}</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                ...
                                {summaryTab === 'current' ? (
                                                ...
                                                <div key={bet.id} className="flex justify-between items-center bg-[#2a2a2a] rounded-lg p-3">
                                                    <div className="flex items-center gap-2">
                                                        <span className={`w-2 h-2 rounded-full ${
                                                            ...
                                                            bet.side === 'wala' ? 'bg-blue-500' : 'bg-green-500'
                                                        }`}></span>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex justify-between items-center bg-[#2a2a2a] rounded-lg p-3">
                                            ...
                                            <span className="text-green-400 font-bold">{summary?.draw_bets || 0}</span>
                                        </div>
                                    </div>
                                )}
                            </div>
            ...
            {/* No Open Fights - Show within main layout */}
