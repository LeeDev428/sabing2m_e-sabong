                            ...
                            <div className="relative mb-4">
                                ...
                                <div className="grid grid-cols-2 gap-0 pt-8">
                                    ...
                                    <button
                                        ...
                                        className={`relative overflow-hidden flex flex-col items-center justify-center py-2.5 px-3 min-h-[80px] transition-all duration-200
                            ...
                            <div className="grid grid-cols-3 gap-1.5 mb-3">
                                {[7, 8, 9, 4, 5, 6, 1, 2, 3].map((num) => (
                                    <button
                                        ...
                                        className="bg-[#f0f0f0] hover:bg-[#e5e5e5] active:bg-[#d5d5d5] text-black py-2 text-2xl font-semibold border border-gray-300 transition-colors"
                                ...
                                {/* Row 4: . / 0 / CLEAR */}
                                <button
                                    className="bg-[#f0f0f0] text-gray-400 py-2 text-2xl font-semibold border border-gray-300 cursor-not-allowed"
                                    style={{ borderRadius: '6px' }}
                                    disabled
                                >
                                    .
                                ...
                                <button
                                    onClick={handleClear}
                                    className="bg-[#f0f0f0] hover:bg-[#e5e5e5] active:bg-[#d5d5d5] text-black py-2 text-sm font-bold border border-gray-300 transition-colors tracking-wide"
                                    style={{ borderRadius: '6px' }}
                                >
                                    CLEAR
                                </button>
