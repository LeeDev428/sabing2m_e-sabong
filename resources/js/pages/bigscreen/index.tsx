        ...
        <div className="relative h-screen w-screen overflow-hidden bg-[#050b1a] text-slate-100">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <img
                    ...
                    className="absolute left-[12%] -translate-x-1/2 top-[9vh] sm:top-[11vh] lg:top-[12vh] h-24 sm:h-32 lg:h-40 w-auto object-contain opacity-42 silhouette-blink"
                />
                <img
                    src="/silhouette/wala.png"
                    alt="Wala silhouette"
                    className="absolute left-[88%] -translate-x-1/2 top-[9vh] sm:top-[11vh] lg:top-[12vh] h-24 sm:h-32 lg:h-40 w-auto object-contain opacity-42 silhouette-blink"
                />
            </div>
