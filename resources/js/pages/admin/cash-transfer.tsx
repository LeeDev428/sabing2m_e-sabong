...
export default function CashTransferMonitoring({ pending, approved, declined, allTransfers, tellers, events = [], filters = {} }: CashTransferProps) {
    ...
    return (
        <AdminLayout>
            <Head title="Cash Transfer Monitoring - Admin" />
